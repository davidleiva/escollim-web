...
const pageStyles = {
  ...
  background: "#00cc66",
  background:
    "linear-gradient(33deg, rgba(0,204,102,1) 0%, rgba(0,204,204,1) 100%)",
  minHeight: "100vh",
    ...
    <main style={pageStyles}>
      <div className="container">
        ...
        <header style={{ textAlign: "center" }}>
          <nav className="navbar navbar-expand-lg navbar-light bg-transparent justify-content-center justify-content-md-between">
            <a className="navbar-brand mb-4" href="/">
              <h1 style={{ lineHeight: "8px" }}>
                <span style={{ fontSize: 0 }}>Escolllim Les Franqueses</span>
                <img src={logo} style={{ width: "240px" }} />
                <br />{" "}
                <span style={{ fontSize: 11, color: "white" }}>
                  Creada por la PAM (Plataforma Afectados Multas)
                </span>
              </h1>
            </a>
            <h4 className="text-center text-md-end mb-4">
              Una plataforma social <br />
              para mejorar Les Franqueses
            </h4>
          </nav>
        </header>
